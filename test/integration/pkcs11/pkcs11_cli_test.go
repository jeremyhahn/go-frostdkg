...
// TestCLIKeygenWithPKCS11 tests key generation into PKCS#11 token.
func TestCLIKeygenWithPKCS11(t *testing.T) {
	t.Skip("TODO: Implement PKCS#11 keygen CLI command")
}
