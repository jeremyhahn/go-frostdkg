...
```
         Peer                                Bootstrap Peers
           ...
           │                                        │
           ▼                                        │
      [DHT Ready] ◄──── 4. Integrated into network ─┘
```
...
```
         Peer                                  DHT Network
           ...
           │         /frost-dkg/v1/session/abc      │
           │                                        │
           │──── 3. Re-advertise (TTL refresh) ────►│
           │                                        │
```
...
```
  Coordinator        Participant 1       Participant 2        DHT Network
       │                    │                    │                    │
       │                    │                    │                    │
       │──────────────── 1. Advertise as coordinator ────────────────►│
       │                    │                    │                    │
       │                    │─────── 2. FindCoordinator ─────────────►│
       │                    │                    │                    │
       │                    │◄────── 3. Coordinator info ─────────────│
