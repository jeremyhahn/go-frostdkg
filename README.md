...
[![Coverage](https://img.shields.io/badge/coverage-91%25-brightgreen.svg)](https://github.com/jeremyhahn/go-frostdkg)
...
| `keygen` | Generate TLS certificates |
...
│   ├── keygen.go         # Certificate generation
